...
const SAMPLE_DECKS = [
    ...
    [
        'Tannuk Budget',
        2,
        'Tannuk deck for 25 Euro.',
        'https://archidekt.com/decks/15136922/tannuk'
    ],
    [
        'Sproofus Aggro',
        4,
        'An agressive mono green deck.',
        'https://archidekt.com/decks/14612865/shroofus'
    ],
    [
        'Zada',
        3,
        'Just another Zada list.',
        'https://archidekt.com/decks/2572012/zada'
    ],
    [
        'Lukas Slimes',
        2,
        'The Lukas Slime deck.',
        'https://archidekt.com/decks/11223185/lukas_slimes'
    ],
    [
        'Jumpstart Piles',
        2,
...
export const POST: RequestHandler = async ({ locals }) => {
    ...
    const createRes = await sheets.spreadsheets.create({
        requestBody: {
            properties: {
                title: 'EDH Demo Database (with sample decks)'
            },
            sheets: [
