  ...
  {:else}
    ...
    {#if deck.stats}
      ...
      <div class="grid gap-4 md:grid-cols-3">
        ...
        <div class="p-4 rounded-xl bg-surface-800 border border-surface-700/60 space-y-2 md:col-span-2">
    ...
    <div class="pt-4">
      <a href="/dashboard" class="text-sm text-primary-300 hover:text-primary-200 underline underline-offset-2">
